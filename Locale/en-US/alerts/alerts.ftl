...
alerts-low-oxygen-desc = У повітрі, яким ви дихаєте, [color=red]недостатньо кисню[/color]. Надягніть [color=green]кисневу маску[/color].
...
alerts-hunger-desc = Трохи їжі зараз не завадить.
...
alerts-vow-silence-desc = Ви дали обітницю мовчання, як частину посвячення у секту Містіко Мімон. Клацність, щоб порушити обітницю.
