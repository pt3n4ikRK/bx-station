...
reagent-desc-zombie-blood = Не раджу вживати в їжу. Можна використовувати для створення щеплення проти інфекції.
...
reagent-desc-vomit = Тут можна побачити кілька шматочків чиєїсь перетравленої їжі.